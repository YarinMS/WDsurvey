function ensureRemoteForcedPhotometryScriptExistsMarv(ipAddress)
    localScriptPath = '~/Documents/WDsurvey/ForcedPhotometryRemote.m'; % Local path of the script
    ...
    scpCommand = sprintf('sshpass -p "physics" scp %s ocs@%s:%s', ...

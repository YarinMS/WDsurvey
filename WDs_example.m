...
for i = 1 : length(fn)
    ...
    FN= [ FN ; strcat('/last01e/data2/archive/LAST.01.01.02/new/', fn(i).name)]
...
E = WDs(Pathway,Names,TargetList(:,1)	,TargetList(:,2)	,TargetList(:,3)    ,TargetList(:,4)	,TargetList(:,5))
...
for Iobj = 1 : E.Nsrc
    ...
    if ~isempty(Isubframe)
        ...
        for Iiter = 1 : length(Isubframe)
            ...
            hold on
            E.Data.Catalog.PSF{Iobj,Iiter}.plotRMS('FieldX','MAG_PSF')
            ...
            E.Data.Catalog.PSFsys{Iobj,Iiter}.plotRMS('FieldX','MAG_PSF','PlotSymbol','.','PlotColor','#77AC30')
    ...
    if ~isempty(Isubframe)
        ...
        for Iiter = 1 : length(Isubframe)
           ...
           % subplot(1,2,1)
            ...
            hold on
            E.Data.Forced.PSFzp{Iobj,Iiter}.plotRMS('FieldX','MAG_PSF')
            ...
            E.Data.Forced.PSFsys{Iobj,Iiter}.plotRMS('FieldX','MAG_PSF','PlotSymbol','.','PlotColor','#77AC30')

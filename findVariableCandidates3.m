            ...
            if FlagGood
                ...
                if ~isempty(WD.Table)
                    ...
                    if ~isempty(Args.catalogChapter)
                          ...
                          appendToReport(Args.catalogChapter, Obj, WDcand{Iwd}, flag, RA, Dec, Args);
                          plotCandidateAndAppend(Obj, IndSrc, RA, Dec, Args.catalogChapter);
...
%%%% Helper functions
function plotCandidateAndAppend(Obj, IndSrc, RA, Dec, chapter)

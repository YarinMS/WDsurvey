...
DataPath = '/last04w/data1/archive/LAST.01.04.03/2024/03/08/proc';
...
FieldIdx = find(contains(FieldNames,'2MASSJ08525'))
...
%% targets in field
Names = ['WDJ085623.58+254008.72',
'WDJ085757.63+254207.73',
'WDJ085458.65+275225.86',
'WDJ085530.17+281031.34',
'WDJ085326.10+255030.07',
'WDJ085410.59+263639.63',
'WDJ085241.11+262329.94',
'WDJ085028.35+271956.28',
'WDJ085144.77+261045.82',
'WDJ085821.45+275956.11',
'WDJ085245.96+264906.42',
'WDJ085650.58+275118.05',

  ]

TargetList = [
134.0981347632343	25.66871618600796	18.54017	19.028177	17.886526
134.49022605730963	25.701905346719414	18.112585	18.397144	17.650612
133.74377626641225	27.873371817260242	17.484528	17.696129	17.139673
133.87567828458688	28.175378900179673	18.761621	18.878958	18.610703
133.3585636406735	25.84174316391291	18.92371	19.222378	18.524525
133.54402981720537	26.611039944124343	19.090502	19.19576	19.03208
133.17099329510583	26.39150382807312	17.650217	17.656061	17.739372
132.6179887466322	27.33215088428851	17.285686	17.22518	17.461664
132.93648604300185	26.179408352135695	18.968569	19.047653	18.930033
134.58931152388382	27.99894033768867	17.93626	17.94217	17.974293
133.1913881734175	26.818255902919656	18.485735	18.472544	18.670568
134.2103694386297	27.854796539847293	18.819603	18.779572	18.860376
];
...
DataPath2 = '/last04w/data1/archive/LAST.01.04.03/2024/03/09/proc';
...
FieldIdx2 = find(contains(FieldNames2,'2MASSJ08525'))
...
Mat = [E.RA, E.Dec, E.G_Bp, T];

%% Save table
monthyear       = date;
montyear.Format = 'MMM-uuuu';
TabName         = ['Table_Results_',FieldNames{FieldIdx(1)},'_',num2str(date.Day),'-',char(date2),'.mat']
...
%% Save mat
TabName         = ['Matrix_Results_',FieldNames{FieldIdx(1)},'_',num2str(date.Day),'-',char(date2),'.mat']
save_path = [save_to,TabName];

% Save table to a file
save(save_path,'Mat','-v7.3')

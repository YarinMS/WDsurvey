...
classdef WDs
    ...
    methods (Static)
        ...
        for Ibatch = 1 : Nbatch
            ...
            %%%%%%%%% ADD FLAGS you have to ask for MASK in the pipeline
            tic ; 
            FP{1,Ibatch} = imProc.sources.forcedPhot(AI,'Coo',[obj.RA(Iobj) obj.Dec(Iobj)],'ColNames',{'RA','Dec','X','Y','Xstart','Ystart','Chi2dof','FLUX_PSF','FLUXERR_PSF','MAG_PSF','MAGERR_PSF','BACK_ANNULUS', 'STD_ANNULUS','FLUX_APER','FLAG_POS'});
            to     = toc;
        ...
        function obj = plotRMSComparison(obj, Args)
            ...
            arguments
              ...
              for Ibatch = 1 : Dim(2)
                 ...
                 % MSmodel2{1,Ibatch}  = FitZP2(  C{1,Ibatch} ,'MagField','MAG_PSF','MagErrField','MAGERR_PSF','title',' only good sources MAG PSF (1 visit)','Title2','ZP - SysRem RMS results  - PSF (1 Visit)')
 ...
 %%                 
                  ...
                  legend('Original RMS', 'Sysrem RMS',sprintf('WD RMS =  %.3f',a.YData(1)),'Interpreter','latex','Location','best');
                  ...
                  t0 = round(t(1)) + 0.5 ; 
                  y = Object{1,Ibatch}.Data.MAG_PSF(Sorted,1);
                  plot(t-t0,y,'-o')
                  hold on;
                  [tsys,Sortedsys] = sort(Csys{1,Ibatch}.JD);
                  ysys = Csys{1,Ibatch}.Data.MAG_PSF(Sortedsys,1);
                  plot(tsys-t0,ysys,'-o')
    ...
    %%
              ...
              % Store Csys in a new field in E
              obj.Data.ForcedBatch.MSsys{WDidx, Iiter} = Csys;
end

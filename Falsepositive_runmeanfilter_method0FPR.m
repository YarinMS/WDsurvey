...
y_zp = MMS.Data.MAG_PSF(indexes,random_index);
...
save('175res5.mat','res5','-v7.3')
save('175res4.mat','res4','-v7.3')
save('175res3.mat','res3','-v7.3')
save('175res2.mat','res2','-v7.3')

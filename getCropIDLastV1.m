function [RES] = getCropIDLastV1(Mount,Camera,year,month,day,targetFieldID,CropID)
...
pathForTgt = sprintf('/%s/%s/archive/LAST.01.%02d.%02d/%04d/%02d/%02d/proc/*v0/*%03d_sci_merged_MergedMat_1.hdf5',computer,dataDir,Mount,Camera,year,month,day,CropID)

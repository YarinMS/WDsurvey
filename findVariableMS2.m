function [Flag, FlagInfo, Summary]=findVariableMS2(Obj, Args)
            ...
            [Flag.FlagGood, FlagInfo]=flagByQuality2(Obj, 'MagField',Args.MagField, 'MaxChi2Dof',Args.MaxChi2Dof, 'MinNdet',Args.MinNdet, 'MaxOverlapFrac',Args.MaxOverlapFrac);
            ...
            for winSize = 6:-1:2
            RMFilt = timeSeries.filter.runMeanFilter(Obj.MS.Data.(Args.MagField),'Threshold', Args.thresholdRMF, 'StdFun', 'OutWin','WinSize',winSize);
            Flag.RunMeanFilt = Flag.RunMeanFilt | any(RMFilt.FlagCand, 1)';

function insertLCDataToDB6(lcData, results, dbPath)
    ...
    createTableSQL = ['CREATE TABLE IF NOT EXISTS LightCurveData (', ...
        ...
        'Detection BOOLEAN, Checkers DOUBLE, SN_3 DOUBLE, SN_2 DOUBLE, Nvisits INTEGER, NvalidPoints INTEGER, ',...
        'Identifier TEXT);'];
   ...
   % if isfield(lcData, 'lc_2'), addColumn('lc_2',uint8(getByteStreamFromArray(lcData.lc_2))); end
    ...
    addColumn('SDNoEvent',results.detection1.lcStdWithoutEvent1);
    addColumn('MedNoEvent',results.detection1.lcMedWithoutEvent1); 
    addColumn('EventDepth',results.detection1.EventDepth1); 

    addColumn('SDNoEvent2',results.detection2.lcStdWithoutEvent2);
    addColumn('MedNoEvent2',results.detection2.lcMedWithoutEvent2); 
    addColumn('EventDepth2',results.detection2.EventDepth2); 


    addColumn('SDNoEvent2Flux',results.detection2flux.lcStdWithoutEvent2flux);
    addColumn('MedNoEvent2Flux',results.detection2flux.lcMedWithoutEvent2flux); 
    addColumn('EventDepth2flux',results.detection2flux.EventDepth2flux); 

   addColumn('SDNoEvent1Flux',results.detection1flux.lcStdWithoutEvent1flux);
    addColumn('MedNoEvent1Flux',results.detection1flux.lcMedWithoutEvent1flux); 
    addColumn('EventDepth1flux',results.detection1flux.EventDepth1flux); 
